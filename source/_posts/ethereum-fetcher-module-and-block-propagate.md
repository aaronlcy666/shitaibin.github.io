...
![图1：新区块传播总体流程图](http://cdn.lessisbetter.site/image-20180821115214521.png-own)
...
策略图的效果如图2，红色节点将区块传播给黄色节点：![图2：产生区块后传播给相邻节点](http://cdn.lessisbetter.site/image-20180821114210114.png-own)

收到区块Hash的节点，需要从发送给它消息的Peer那里获取对应的完整区块，获取区块后就会按照图1的流程，加入到fetcher队列，最终插入本地区块链后，**将区块的Hash值广播给和它相连，但还不知道这个区块的Peer**。非产生区块节点的策略图，如图3，黄色节点将区块Hash传播给青色节点：![图3：非产块节点传播新区块](http://cdn.lessisbetter.site/image-20180821114756055.png-own)
...
![fetcher功能抽象](http://cdn.lessisbetter.site/image-20180821175330370.png-own)
...
![图4：产块节点的传播图](http://cdn.lessisbetter.site/image-20180821115537184.png-own)
...
![图5：远端节点处理新区块](http://cdn.lessisbetter.site/image-20180821143403650.png-own)
...
![图6：节点获取完整区块的时序图](http://cdn.lessisbetter.site/image-20180822103401508.png-own)
...
![图7：获取区块状态转移图](http://cdn.lessisbetter.site/image-20180822103701006.png-own)
